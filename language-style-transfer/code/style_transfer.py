...
class Model(object):
    ...
    def __init__(self, args, vocab):
        ...
        #####   auto-encoder   #####
        init_state = tf.concat(axis=1, values=[linear(labels, dim_y, scope='encoder'),
        ...
        self.h_ori = tf.concat(axis=1, values=[linear(labels, dim_y,
            scope='generator'), z])
        self.h_tsf = tf.concat(axis=1, values=[linear(1-labels, dim_y,
