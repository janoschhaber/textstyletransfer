...
def create_model(sess, args, vocab):
    ...
    if args.load_model:
        ...
        tf.logging.info('Creating model with fresh parameters.')
...
if __name__ == '__main__':
    ...
    tf.logging.info('vocabulary size', vocab.size)
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.test:
            ...
            tf.logging.info('test accuracy %.2f' % acc)
